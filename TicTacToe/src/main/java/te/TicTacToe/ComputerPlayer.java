...
public class ComputerPlayer {
	...
	public boolean blockOpponentCanWin(Game gameBoard) {
		...
		if (blockOpponentCanWinRowsCols(gameBoard)) {
			return true;
		}
		if (blockOpponentCanWinDiagonal(gameBoard)) {
			return true;
		}
		return false;
	...
	public boolean blockOpponentCanWinRowsCols(Game gameBoard) {
	...
	public boolean blockOpponentCanWinDiagonal(Game gameBoard) {
		String[][] board = gameBoard.getBoard();
		String playerMarker = " X ";
		String empty = "   ";
		// Check diagonals
